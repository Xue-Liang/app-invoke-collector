...
public abstract class AbstractAppDao {
    ...
    private static final RowMapper<App> mapper = new BeanPropertyRowMapper<App>(App.class);

    private static final ResultSetExtractor<App> extractor = new ResultSetExtractor<App>() {
        @Override
    ...
    private static final String insert = "insert into app (name,create_time,update_time)values(?,?,?)";
    ...
    */
    ...
    private static final String queryFirst = "select id,name,create_time,update_time from app  where  id=? ";
